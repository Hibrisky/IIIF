...
namespace ARFoundationRemote.RuntimeEditor {
    ...
    public class Receiver: MonoBehaviour {
        ...
        public static event Action<PlayerToEditorMessage> onPlayerMessageReceived = delegate { };
        ...
        void Awake() {
            ...
            receivers.Add(new LocationServicesReceiver());
        ...
        void addSubsystemToReceivers<T>() where T : class, ISubsystem {
            ...
            if (Defines.isUnity2019_2 && activeLoader == null) {
                throw new Exception($"{Constants.packageName}: please install \"com.unity.xr.management\": \"3.0.4-preview.1\"");
            }
